...
/datum/design/autolathe/shotgun_flash
	name = "ammunition (shotgun, flash)"
	build_path = /obj/item/ammo_casing/shotgun/flash

/datum/design/autolathe/magazine_smg_rubber
