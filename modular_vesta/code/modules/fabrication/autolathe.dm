...
/obj/machinery/autolathe
	...
	var/list/suitable_materials = list(MATERIAL_STEEL, MATERIAL_GLASS, MATERIAL_ALUMINIUM, MATERIAL_PLASTIC) //List that limits autolathes to eating mats only in that list.
...
/obj/machinery/autolathe/proc/eject(var/material, var/amount)
	...
	if(eject > 0)
		mat.place_sheet(get_turf(src), eject)
